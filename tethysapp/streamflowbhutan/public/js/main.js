...
myApp.myMap = function () {
    ...
    var bounds = [9837262.194742935, 3033270.477512493, 10298024.601245979, 3295908.106700358];
...
myApp.AddLayers = async function () {
    ...
    var Outline = new ol.layer.Tile({
        ...
        title: 'Outline',
        visible: false,
        legendPath: LegendSource + 'admin:bhutan_boundary',
        source: new ol.source.TileWMS({
            url: datasource,
            hidpi: false,
            params: {
                'VERSION': '1.1.1',
                'LAYERS': 'admin:bhutan_boundary',
                'TILED': true
            },
    ...
    myApp.HiwatRiverWMSSource = new ol.source.TileWMS({
        url: datasource,
        params: {
            'LAYERS': 'Nepal:bhutanRiver', 'TILED': true
        },
        serverType: 'geoserver',
        crossOrigin: 'anonymous'
    });
    ...
    myApp.HiwatRiver = new ol.layer.Tile({
        id: 'HIWATRiverHKH',
        title: 'HIWAT Rivers',
        legendPath: LegendSource + 'Nepal:bhutanRiver',
        visible: true,
